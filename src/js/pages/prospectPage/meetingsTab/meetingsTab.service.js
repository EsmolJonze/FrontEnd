...
const baseQuery = (salesFeatureEnabled, activeUser) => ({
  ...
  TASK__TASK_TYPE: ['CONTACT_BEFORE_MEETING'],
});
...
export const overdueMeetings = (salesFeatureEnabled, activeUser) => ({
...
export const todayMeetings = (salesFeatureEnabled, activeUser) => ({
  ...baseQuery(salesFeatureEnabled, activeUser),
  ...makeQueryDate(0),
  TASK__STATUS: ['TASK__STATUS__TODO'],
});
...
export const tasksLists = (salesFeatureEnabled, activeUser) => [
  {
    ...
    pageSize: 50,
    query: overdueMeetings(salesFeatureEnabled, activeUser),
  },
  {
    ...
    pageSize: 50,
    date: new Date(),
    query: todayMeetings(salesFeatureEnabled, activeUser),
  },
  {
