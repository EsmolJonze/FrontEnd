...
export const overdueNextSteps = salesFeatureEnabled => ({
...
export const todayNextSteps = salesFeatureEnabled => ({
  ...baseQuery(salesFeatureEnabled),
  ...makeQueryDate(0),
  TASK__STATUS: ['TASK__STATUS__TODO'],
});
...
export const tasksLists = salesFeatureEnabled => [
  {
    ...
    pageSize: 50,
    query: overdueNextSteps(salesFeatureEnabled),
  },
  {
    ...
    pageSize: 50,
    date: new Date(),
    query: todayNextSteps(salesFeatureEnabled),
  },
  {
